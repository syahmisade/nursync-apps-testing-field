    ...
    <div className="flex flex-col h-full">
      <div className="sticky top-0 z-30 flex-shrink-0" style={{ background: 'hsl(270, 40%, 97%)' }}>
        <div className="px-5 pt-4 pb-2 flex items-center gap-1">
          <img src="https://media.base44.com/images/public/6a09fb9ae5c8de3d68cfbc57/b7b6d0ba5_generated_image.png" alt="" className="w-20 h-20 object-contain flex-shrink-0" style={{ mixBlendMode: 'multiply', transform: 'scale(1.8)', transformOrigin: 'center', background: 'transparent' }} />
